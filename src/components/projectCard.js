                ...
                <div className="project-card__overlay-content">
                    ...
                    { websiteLink && 
                        <div className="project-card__overlay__link-group">
                            ...
                            <a href={websiteLink} target="_blank" rel="noreferrer" className="project-card__overlay__link color--white">Visit website</a>
                        </div>
                    }
                    ...
                    { githubLink && 
                        <div className="project-card__overlay__link-group">
                            ...
                            <a href={githubLink} target="_blank" rel="noreferrer" className="project-card__overlay__link color--white">See source code</a>
                        </div>
                    }
                </div>
            </div>
